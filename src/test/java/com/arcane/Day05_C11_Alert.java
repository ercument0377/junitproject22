...
public class Day05_C11_Alert {
    /*
    Go to https://the-internet.herokuapp.com/javascript_alerts  git
 ...
 */
 ...
 //      Assert.assertEquals("Metinler eslesmiyor:","I am a JS Confirm",driver.switchTo());
    ...
    public void sendKeysAlert() {
        ...
        driver.findElement(By.xpath("//button[@onclick='jsProrpt()']")).click();
