...
//        3. Cookies isimleriyle yazdir
        System.out.println(" Cookie ismi session-id-time olan cookie : "+
                driver.manage().getCookieNamed("session-id-time"));
...
//        4. Yeni cookie ekle
       ...
       //cookie ekle
        ...
        //tum cookileri al vesayısını yazdır
        tumCookies = driver.manage().getCookies();

        System.out.println(tumCookies.size());

//        5. Cookie ismiyle sil
        driver.manage().deleteCookieNamed("css-hit");
